...
Class ORACLE
{
	...
	/*var $DBASE = "klore";		// Set name of database to use
	var $USER = "webedit";			// Set database username
	var $PASS = "C0ur8eM3re";			// Set darabase R/W password
...
//	The power of recursive queries
	...
	function suggest ($postData="",&$err_msg)
	{
		...
		*/
		...
		$resid = $db->nextID("AUTO_RESOURCE_LINKS_LINKID");
	...
	function add_cat ($postData="",&$err_msg)
	{
		...
		$resid = $db->nextId("AUTO_RESOURCE_CATEGORIES_CATID");
