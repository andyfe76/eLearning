...
//
// --------------------------------------------------------------------------------
// $Id: pclzip-trace.lib.php,v 1.19 2003/02/07 20:44:10 vblavet Exp $
// --------------------------------------------------------------------------------
...
//  function create($p_filelist, $p_add_dir="", $p_remove_dir="")
  function create($p_filelist /*, options */)
  {
    ...
    // ----- Trace
    PclTraceFctMessage(__FILE__, __LINE__, 2, "add_path='$v_add_path', remove_path='$v_remove_path', remove_all_path='".($v_remove_all_path?'true':'false')."'");
...
// --------------------------------------------------------------------------------
  ...
  {
    PclTraceFctStart(__FILE__, __LINE__, "PclZip::privExtract", "list, path=$p_path, remove_path='$p_remove_path', remove_all_path='".($p_remove_all_path?'true':'false')."'");
    $v_result=1;
  ...
  {
    PclTraceFctStart(__FILE__, __LINE__, "PclZip::privExtractByIndex", "list, index='$p_index', path=$p_path, remove_path='$p_remove_path', remove_all_path='".($p_remove_all_path?'true':'false')."'");
    $v_result=1;
  ...
  function privExtractFile(&$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
  {
    ...
    } else if ($p_entry['status'] == 'skipped') {
		$v_result = 1;
	}
