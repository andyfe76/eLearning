<?php
/** $Id: HTML_ToPDF.php 905 2003-11-14 00:14:51Z jrust $ */
// {{{ license
...
class HTML_ToPDF {
     ...
     * @var string
     */
    var $tmpDir = '/var/www/html/klore/content/export';
    ...
    var $html2psrc = '
        ...
        package {
		  ...
		  ImageMagick: 1; /* tell html2ps that ImageMagick is available */ 
        }
    ...
    function convert()
    {
        ...
        $tmp_result = array();
        $cmd = $this->ps2pdfPath . ' -sPAPERSIZE=' . $paperSize . 
