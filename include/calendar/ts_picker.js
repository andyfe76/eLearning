...
function dt2dtstr (dt_datetime) {
		var cdate = dt_datetime.getDate() +"";
		var cmonth = (dt_datetime.getMonth() +1) + "";
		var cyear = dt_datetime.getFullYear() + "";
...
function dt2tmstr (dt_datetime) {
		var chour = dt_datetime.getHours() +"";
		var cmin = (dt_datetime.getMinutes() +1) + "";
		var csec = dt_datetime.getSeconds() + "";
