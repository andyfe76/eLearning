...
function smile_replace($text) {
	...
	$smiles[0] = '<img src="images/forum/smile.gif" border="0" height="15" width="15" align="bottom" alt="smile" />';
	$smiles[1] = '<img src="images/forum/wink.gif" border="0" height="15" width="15" align="bottom" alt="wink" />';
	$smiles[2] = '<img src="images/forum/frown.gif" border="0" height="15" width="15" align="bottom" alt="frown" />';
	$smiles[4]= '<img src="images/forum/happy.gif" border="0" height="15" width="15" align="bottom" alt="happy" />';
	$smiles[5]= '<img src="images/forum/ohwell.gif" border="0" height="15" width="15" align="bottom" alt="oh well" />';
	$smiles[6]= '<img src="images/forum/tongue.gif" border="0" height="15" width="15" align="bottom" alt="tongue" />';
	$smiles[7]= '<img src="images/forum/51.gif" border="0" height="15" width="15" align="bottom" alt="evil" />';
	$smiles[8]= '<img src="images/forum/52.gif" border="0" height="15" width="15" align="bottom" alt="angry" />';
	$smiles[9]= '<img src="images/forum/54.gif" border="0" height="15" width="15" align="bottom" alt="lol" />';
	$smiles[10]= '<img src="images/forum/55.gif" border="0" height="15" width="15" align="bottom" alt="wow" />';
	$smiles[11]= '<img src="images/forum/17.gif" border="0" height="21" width="37" align="bottom" alt="finger" />';
	$smiles[12]= '<img src="images/forum/37.gif" border="0" height="23" width="42" align="bottom" alt="angel" />';
	$smiles[13]= '<img src="images/forum/27.gif" border="0" height="15" width="15" align="bottom" alt="crazy" />';
	$smiles[14]= '<img src="images/forum/26.gif" border="0" height="15" width="60" align="bottom" alt="puke" />';
	$smiles[15]= '<img src="images/forum/30.gif" border="0" height="15" width="15" align="bottom" alt="love" />';
	$smiles[16]= '<img src="images/forum/19.gif" border="0" height="15" width="15" align="bottom" alt="tired" />';
	$smiles[17]= '<img src="images/forum/3.gif" border="0" height="17" width="19" align="bottom" alt="confused" />';
	$smiles[18]= '<img src="images/forum/56.gif" border="0" height="15" width="15" align="bottom" alt="muah" />';
	$smiles[19]= '<img src="images/forum/57.gif" border="0" height="15" width="15" align="bottom" alt="roll eyes" />';
	$smiles[20]= '<img src="images/forum/58.gif" border="0" height="15" width="15" align="bottom" alt="licks" />';
...
function myCodes($text) {
	...
	$text = str_replace('[/op]','">'.$_template['view_entire_post'].'</a>',$text);
	...
	$text = str_replace('[cid]','?cid='.$_SESSION['s_cid'],$text);

	//Replace learning concept codes with icons
	foreach ($learning_concept_tags as $tag => $concept) {
		if ($tag == 'link') {
			$text = str_replace('['.$tag.']','<a href="resources/links/"><img src="images/concepts/'.$concept['icon_name'].'" alt="'.$concept['title'].'" border="0" /></a>', $text);
		} else if ($tag == 'discussion') {
			$text = str_replace('['.$tag.']','<a href="forum/"><img src="images/concepts/'.$concept['icon_name'].'" alt="'.$concept['title'].'" border="0" /></a>', $text);
		} else {
			$text = str_replace('['.$tag.']','<img src="images/concepts/'.$concept['icon_name'].'" alt="'.$concept['title'].'" />', $text);
		}
	}
