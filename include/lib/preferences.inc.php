...
<tr>
	...
	<tr>
		<th colspan="3"><?php print_popup_help(AT_HELP_DISPLAY_OPTIONS); ?>
	...
	<tr>
		<td class="row1" colspan="2"><label for="seq"><?php echo $_template['seq_links'];  ?>:</label></td>
		<td class="row1"><?php
	...
	<tr><td height="1" class="row2" colspan="3"></td></tr>
	<tr>
		<td class="row1" colspan="2"><label for="toc"><?php echo $_template['table_of_contents_location'];  ?>:</label></td>
		<td class="row1">
		<?php
