...
define('AT_ERROR_GROUP_MISSING', $i); $i++;
define('AT_ERROR_GROUP_EXISTING', $i); $i++;
define('AT_ERROR_BAD_GROUP_NAME', $i); $i++;
define('AT_ERROR_NO_COURSE_GROUP', $i); $i++;
...
define('AT_ERRORS_QUESTION_EMPTY', $i); $i++;
...
define('AT_ERROR_INVALID_MIN_GRADE', $i); $i++;
...
define('AT_HELP_CONTROL_CENTER3', $i); $i++;
...
define('AT_HELP_NUMBER_QUESTIONS', $i); $i++;
define('AT_HELP_MIN_GRADE', $i); $i++;
define('AT_HELP_SPECIAL_INSTRUCTIONS', $i); $i++;
define('AT_HELP_COURSE_START_DATE', $i); $i++;
define('AT_HELP_COURSE_END_DATE', $i); $i++;
define('AT_HELP_COURSE_PERIOD', $i); $i++;
define('AT_HELP_TEST_RETRIES', $i); $i++;
define('AT_HELP_TEST_DURATION', $i); $i++;
...
define('AT_FEEDBACK_ADDED_USER', $i); $i++;
...
define('AT_FEEDBACK_HEADER_UPLOADED', $i); $i++;
...
define('AT_FEEDBACK_COURSE_RESTORED', $i); $i++;
...
define('AT_FEEDBACK_COURSE_OPTIONS', $i); $i++;
...
define('AT_FEEDBACK_TEST_TIME_EXPIRED', $i); $i++;
define('AT_FEEDBACK_TEST_RETRIES_NOMORE', $i); $i++;
