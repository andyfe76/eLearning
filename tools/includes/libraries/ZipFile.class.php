 ...
 * Proudly Supported by Eternity Technologies (http://eternitytechnologies.com)
 * Personal Edition, released under the GNU/GPL
 *
 * Zip file creation class makes zip files on the fly...
 * Released under GNU/GPL by the original authors
 *
