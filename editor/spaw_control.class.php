...
class SPAW_Wysiwyg {
  ...
  function getHtml()
  {
    ...
    if ($this->checkBrowser())
    {
      ...
      $buf.= '<textarea id="'.$n.'" name="'.$n.'" style="width:100%; height:'.$this->getHeight().'; display:none; border:0px;" class="SPAW_'.$this->theme.'_editarea"></textarea>';
      ...
      {
        $buf.="setTimeout('document.all.".$n.".value +=\"".str_replace('"','&quot;',str_replace("'","\'",$line))."\";',0);\n";
      }
